...
import realProfile from "../assets/img/Grad.webp";
import hoverProfile from "../assets/img/Grad2.webp";
...
function Home() {
  ...
  return (
    <>
      <HelmetProvider>
        <Helmet>
          <title>Ziad elsharkawy - Home</title>
        </Helmet>
      </HelmetProvider>
      <Container fluid className="home-wrapper">
        <div className="home-left animate__animated animate__fadeInLeft">
          ...
          <h2>
            <span className="name-hover">Ziad</span>
            <br />
            <span className="name-hover">Elsharkawy</span>
          </h2>
